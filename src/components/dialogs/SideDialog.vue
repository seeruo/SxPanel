<template>
    <transition name="sidefade-fade" @after-leave="afterLeave">
...
.sidefade-fade-enter-active, .sidefade-fade-leave-active {
    transform: translateX(0);
    transition: transform .3s;
}
.sidefade-fade-enter, .sidefade-fade-leave-to /* .sidefade-fade-leave-active below version 2.1.8 */ {
